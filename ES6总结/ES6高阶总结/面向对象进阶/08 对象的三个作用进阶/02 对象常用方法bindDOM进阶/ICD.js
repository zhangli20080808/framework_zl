 ...
 * ICD Library v1.0.0
 *
 * Includes select.js, event-loop.js, animate.js
 *
	...
	ICD.extend({
		css : function(){
			...
			if(len === 1){
				...
				}else if(typeof arg[0] === 'object.create.js'){
					for(var i in arg[0]){
	...
	Animate.prototype = {
		...
		,begin : function(){
			if(typeof arguments[0] === 'boolean' && arguments[0]){
				this._run();
			}else if(typeof arguments[0] === 'object.create.js'){
		...
		,create : function(){
			...
			if(len > cout){
				if(typeof arguments[cout] === "object.create.js"){
